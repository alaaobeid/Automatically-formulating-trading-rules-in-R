...
Automatically formualting trading rules is a huge area, so in order to narrow our scope I have focused on using Genetic Programming to evolve a function of future stock close prices, using this as a means of automatically buying and selling stock.  
...
We chose to use Amazon stock data as it has nice variation throughout the year. This is beneficial, as the Genetic Program takes a lagged dataframe as input, represenatig N days worth of returns in one row). 
